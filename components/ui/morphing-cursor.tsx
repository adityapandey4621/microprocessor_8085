...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-5xl md:text-[6.5vw] font-semibold tracking-tighter font-space uppercase text-[#C89B3C] tracking-wide">{text}</span>

      <div
        ref={circleRef}
        className="absolute top-0 left-0 pointer-events-none rounded-full bg-[#EAEAEA] overflow-hidden"
        style={{
      ...
      >
        ...
        >
          <span className="text-5xl md:text-[6.5vw] font-semibold tracking-tighter font-space uppercase text-[#030303] whitespace-nowrap tracking-wide">
            {hoverText}
          </span>
        </div>
      </div>
